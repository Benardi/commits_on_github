...
* In terms of **sample** Python seems to be more popular than Java.
...
* Let's bootstrap the unpaired difference between java popularity during the week and java popularity druing the weekend.
...
* The C.I shows us that Python is more popular during the week (Interval is exclusively above 0). 
...
* In terms of **sample** we see more clearly that Pythonis more popular on weekends than Java.
...
> Looking at the confidence intervals (C.I.) of the unpaired difference between Java and Python popularity during the weekend **we can say at a 95% degree of confidence Python is significantly more popular during the weekend than Java**.  
